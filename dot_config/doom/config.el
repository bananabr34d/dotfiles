...
;; accept. For example:
;;
;; (setq doom-font (font-spec :family "JetBrainsMonoNF" :size 15 :weight 'semi-light)
;;     doom-variable-pitch-font (font-spec :family "JetBrainsMonoNF" :size 13))
;;
...
(setq doom-font (font-spec :family "JetBrainsMonoNerdFont" :size 25))
